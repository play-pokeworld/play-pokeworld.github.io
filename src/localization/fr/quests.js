// ===== FR — Quest texts (main / side / repeatable) — phase 18: renumbered & rival/Rocket arc texts =====
// quests.<cat>.<id>.{title,desc,rewardDesc}
export const L_fr_quests = {
"main": {
"1": {
...
"16": {
"title":"Les Herbes de la Route 5",
...
"rewardDesc":"20 000₽ + Celebi (Nv.50)"
  ...
  "219": {
    "title": "Autéquia des cendres",
    "desc": "Visiter Autéquia et parler à l'astronome.",
    "rewardDesc": "900₽"
  },
  "220": {
  ...
  "222": {
    ...
    "desc": "Vaincre Adriane à l'Arène de Vermilava.",
  ...
  "227": {
    "title": "Le Sixième Badge (Cimetronelle)",
    "desc": "Vaincre Alizée à l'Arène de Cimetronelle.",
...
"desc":"Le Gardien Jo défie les nouveaux venus : mettez K.O. 12 Pokémon sauvages sur la Route 22 !",
"rewardDesc":"1 600₽"
},
"s4": {
...
"desc":"L'Exorciste Lila vous demande : vainquez 12 Pokémon à la Tour Pokémon.",
...
"s34": {
"title":"L'Explorateur des Caves Jumelles",
"desc":"Un chercheur de Lokhlass explore les Caves Jumelles : 10 victoires !",
...
"desc":"Le Roi du Karaté Fabrice n'accepte que les dresseurs endurants : 15 K.O. sauvages au Mont Creuset !",
...
"s100": { "title":"Sanctuaire — Peuple antique", "desc":"Au Sanctuaire sous la Route 134, invoquez Relicanth puis Wailord.", "rewardDesc":"4 200₽ + Pierre Dure" },
...
"s134": { "title":"Rencontre — Algatia", "desc":"Parlez à l’habitant d'Algatia.", "rewardDesc":"1 200₽ + Cuillère Tordue" },
"s135": { "title":"Rencontre — Atalanopolis", "desc":"Parlez à l’habitant d'Atalanopolis.", "rewardDesc":"1 500₽ + Eau Mystique" },
"s136": { "title":"Rencontre — Pacifiville", "desc":"Parlez à l’habitant de Pacifiville.", "rewardDesc":"1 200₽ + Écaille Draco" },
"s137": { "title":"Rencontre — Autéquia", "desc":"Parlez à l’habitant d'Autéquia.", "rewardDesc":"1 000₽ + Pierre Lune" }
},
...
// Vague 39 — réconciliation : la table de descriptions (615 clés) vit dans sa
// maison canonique fr/move-descs.js ; ce fichier la ré-exporte (contrat ESM intact).
export { L_fr_move_descs } from './move-descs.js';
