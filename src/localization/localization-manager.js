...
// T2 (vague 37) : module ESM — instance canonique exposée sur l'objet global.
// Références tardives préservées à l'identique (globalThis.L relu à l'appel,
// comme l'ancien window.L) ; les gardes `if (!…)`/`typeof !== 'function'`
// conservent la sémantique de premier-arrivé.
if (typeof globalThis !== 'undefined') {
  globalThis.PokeLocalization = Localization;
  // Legacy compatibility
  if (!globalThis.L) globalThis.L = new Localization();
  globalThis.L_set = (lang) => globalThis.L.set(lang);
  if (typeof globalThis.t !== 'function') globalThis.t = (key, ...args) => globalThis.L.t(key, ...args);
  if (typeof globalThis.tr !== 'function') globalThis.tr = (key, vars) => globalThis.L.tr(key, vars);

  if (!globalThis.poke) globalThis.poke = {};
  globalThis.poke.Localization = Localization;
}
export { Localization };
