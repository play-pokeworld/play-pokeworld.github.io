...
function startLegendaryEncounter(pokeId){
 ...
 addBattleLog(lang === 'en' ? `⚔ WILD LEGENDARY: ${legPoke.name} (Lv.65) appeared! Defeat it to capture!` : `⚔ LÉGENDAIRE SAUVAGE : ${legPoke.name} (Nv.65) apparaît ! Vainquez-le pour le capturer !`);
...
function spawnNextWild(){
 ...
 battle.playerMods={atk:1,def:1,spe:1}; // Reset player mods too
 battle.eMoveIdx=0;
