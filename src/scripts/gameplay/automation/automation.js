...
function renderAutomationWindow(){
 ...
 el.innerHTML = `
 <div style="font-size:13px;color:var(--light1);margin-bottom:4px;">
 ${t("m.automation.7")}
 </div>
 ...
 <div>
 <b style="color:#fff;font-size: 13px;"> ${t("m.automation.6")}</b>
 <div style="font-size: 13px;color:var(--light1);">${t("m.automation.5")}</div>
 </div>
 ...
 <label style="display:flex;align-items:center;justify-content:space-between;background:rgba(0,0,0,0.25);padding:8px;border-radius:6px;border:1px solid #3c5c27;cursor:pointer;">
 <div>
 <b style="color:#fff;font-size: 13px;"> ${t("m.automation.4")}</b>
 <div style="font-size: 13px;color:var(--light1);">${t("m.automation.3")}</div>
 </div>
