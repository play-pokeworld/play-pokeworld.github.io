...
function createPoke(id, level, shinyUnlocked=false){
   ...
   if(typeof TALENTS_FULL !== 'undefined') {
     ...
     if(available.length > 0) {
       ...
       if(roll < 60) {
         ...
         // 30% chance for uncommon (rarity 2)
 ...
 // Save unlocked talents for this species
