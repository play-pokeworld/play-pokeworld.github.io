...
const PD = [
  ...
  ['Germignon','Grass',null, 45,49,65,49,65,45, ['vinewhip', 'razorleaf', 'solarbeam', 'absorb'], 45, 64],
  ['Macronium','Grass',null, 60,62,80,63,80,60, ['vinewhip', 'razorleaf', 'solarbeam', 'absorb'], 45, 142],
  ['Méganium','Grass',null, 80,82,100,83,100,80, ['vinewhip', 'razorleaf', 'solarbeam', 'absorb'], 45, 236],
  ['Héricendre','Fire',null, 39,52,43,60,50,65, ['ember', 'flamethrower', 'fireblast', 'fieryspin'], 45, 65],
  ['Feurisson','Fire',null, 58,64,58,80,65,80, ['ember', 'flamethrower', 'fireblast', 'fieryspin'], 45, 142],
  ['Typhlosion','Fire',null, 78,84,78,109,85,100, ['ember', 'flamethrower', 'fireblast', 'fieryspin'], 45, 240],
  ['Kaiminus','Water',null, 50,65,64,44,48,43, ['watergun', 'bubble', 'surf', 'hydropump'], 45, 66],
  ['Crocrodil','Water',null, 65,80,80,59,63,58, ['watergun', 'bubble', 'surf', 'hydropump'], 45, 142],
  ['Aligatueur','Water',null, 85,105,100,79,83,78, ['watergun', 'bubble', 'surf', 'hydropump'], 45, 239],
  ['Fouinette','Normal',null, 35,46,34,35,45,20, ['tackle', 'scratch', 'slash', 'quickattack'], 255, 50],
  ['Fouinar','Normal',null, 85,76,64,55,66,90, ['tackle', 'scratch', 'slash', 'quickattack'], 90, 145],
  ['Hoothoot','Normal','Flying', 60,30,30,36,56,50, ['tackle', 'scratch', 'slash', 'quickattack'], 255, 52],
  ['Noarfang','Normal','Flying', 100,50,50,86,96,70, ['tackle', 'scratch', 'slash', 'quickattack'], 90, 158],
  ['Coxy','Bug','Flying', 40,20,30,40,80,55, ['stringshot', 'bugbite', 'gust', 'wingattack'], 255, 53],
  ['Coxyclaque','Bug','Flying', 55,35,50,55,110,85, ['stringshot', 'bugbite', 'gust', 'wingattack'], 90, 137],
  ['Mimigal','Bug','Poison', 40,60,40,40,40,30, ['stringshot', 'bugbite', 'poisonsting', 'sludgebomb'], 255, 50],
  ['Migalos','Bug','Poison', 70,90,70,60,60,40, ['stringshot', 'bugbite', 'poisonsting', 'sludgebomb'], 90, 137],
  ['Nostenfer','Poison','Flying', 85,90,80,70,80,130, ['poisonsting', 'sludgebomb', 'toxic', 'gust'], 90, 204],
  ['Loupio','Water','Electric', 75,38,38,56,56,67, ['watergun', 'bubble', 'surf', 'hydropump'], 190, 66],
  ['Lanturn','Water','Electric', 125,58,58,76,76,67, ['watergun', 'bubble', 'surf', 'hydropump'], 75, 165],
  ['Pichu','Electric',null, 20,40,15,35,35,60, ['thundershock', 'thunderbolt', 'thunder', 'thunderwave'], 190, 41],
  ['Mélo','Fairy',null, 50,25,28,45,55,15, ['dazzlinggleam', 'moonblast', 'tackle', 'quickattack'], 150, 44],
  ['Toudoudou','Normal','Fairy', 90,30,15,40,20,15, ['tackle', 'scratch', 'slash', 'quickattack'], 170, 42],
  ['Togepi','Fairy',null, 35,20,65,40,65,20, ['dazzlinggleam', 'moonblast', 'tackle', 'quickattack'], 140, 49],
  ['Togetic','Fairy','Flying', 55,40,85,80,105,40, ['dazzlinggleam', 'moonblast', 'gust', 'wingattack'], 75, 142],
  ['Natu','Psychic','Flying', 40,45,45,70,45,70, ['confusion', 'psychic', 'psybeam', 'gust'], 190, 64],
  ['Xatu','Psychic','Flying', 65,75,70,95,95,95, ['confusion', 'psychic', 'psybeam', 'gust'], 75, 165],
  ['Wattouat','Electric',null, 55,40,40,65,45,35, ['thundershock', 'thunderbolt', 'thunder', 'thunderwave'], 190, 59],
  ['Lainergie','Electric',null, 70,55,55,80,60,45, ['thundershock', 'thunderbolt', 'thunder', 'thunderwave'], 120, 128],
  ['Pharamp','Electric',null, 90,75,85,115,90,55, ['thundershock', 'thunderbolt', 'thunder', 'thunderwave'], 45, 230],
  ['Joliflor','Grass',null, 75,80,85,100,90,50, ['vinewhip', 'razorleaf', 'solarbeam', 'absorb'], 45, 216],
  ['Marill','Water','Fairy', 70,20,50,20,50,40, ['watergun', 'bubble', 'surf', 'hydropump'], 190, 71],
  ['Azumarill','Water','Fairy', 100,50,80,60,80,50, ['watergun', 'bubble', 'surf', 'hydropump'], 75, 185],
  ['Simularbre','Rock',null, 70,100,115,30,65,30, ['rockthrow', 'rockslide', 'stoneedge', 'tackle'], 65, 137],
  ['Tarpaud','Water',null, 90,75,75,90,100,70, ['watergun', 'bubble', 'surf', 'hydropump'], 45, 230],
  ['Granivol','Grass','Flying', 35,35,40,35,55,50, ['vinewhip', 'razorleaf', 'solarbeam', 'absorb'], 255, 50],
  ['Floravol','Grass','Flying', 55,45,50,45,65,80, ['vinewhip', 'razorleaf', 'solarbeam', 'absorb'], 120, 119],
  ['Cotovol','Grass','Flying', 75,55,70,55,85,110, ['vinewhip', 'razorleaf', 'solarbeam', 'absorb'], 45, 200],
  ['Capumain','Normal',null, 55,70,55,40,55,85, ['tackle', 'scratch', 'slash', 'quickattack'], 120, 100],
  ['Tournegrin','Grass',null, 30,30,30,30,30,30, ['vinewhip', 'razorleaf', 'solarbeam', 'absorb'], 235, 36],
  ['Héliatronc','Grass',null, 75,75,55,105,85,30, ['vinewhip', 'razorleaf', 'solarbeam', 'absorb'], 120, 151],
  ['Yanma','Bug','Flying', 65,65,45,75,45,95, ['stringshot', 'bugbite', 'gust', 'wingattack'], 75, 78],
  ['Axoloto','Water','Ground', 55,45,45,25,25,15, ['watergun', 'bubble', 'surf', 'hydropump'], 255, 42],
  ['Maraiste','Water','Ground', 95,85,85,65,65,35, ['watergun', 'bubble', 'surf', 'hydropump'], 90, 151],
  ['Mentali','Psychic',null, 65,65,60,130,95,110, ['confusion', 'psychic', 'psybeam', 'tackle'], 45, 184],
  ['Noctali','Dark',null, 95,65,110,60,130,65, ['bite', 'crunch', 'tackle', 'quickattack'], 45, 184],
  ['Cornèbre','Dark','Flying', 60,85,42,85,42,91, ['bite', 'crunch', 'gust', 'wingattack'], 30, 108],
  ['Roigada','Water','Psychic', 95,75,80,100,110,30, ['watergun', 'bubble', 'surf', 'hydropump'], 70, 172],
  ['Feuforêve','Ghost',null, 60,60,60,85,85,85, ['lick', 'shadowball', 'nightshade', 'tackle'], 45, 159],
  ['Zarbi','Psychic',null, 48,72,48,72,48,48, ['confusion', 'psychic', 'psybeam', 'tackle'], 225, 61],
  ['Qulbutoké','Psychic',null, 190,33,58,33,58,33, ['confusion', 'psychic', 'psybeam', 'tackle'], 45, 142],
  ['Girafarig','Normal','Psychic', 70,80,65,90,65,85, ['tackle', 'scratch', 'slash', 'quickattack'], 90, 140],
  ['Pomdepik','Bug',null, 50,65,90,35,35,15, ['stringshot', 'bugbite', 'tackle', 'quickattack'], 190, 59],
  ['Foretress','Bug','Steel', 75,90,140,60,60,40, ['stringshot', 'bugbite', 'metalclaw', 'irontail'], 75, 163],
  ['Insolourdo','Normal',null, 100,70,70,65,65,45, ['tackle', 'scratch', 'slash', 'quickattack'], 90, 145],
  ['Scorplane','Ground','Flying', 65,75,105,35,65,85, ['dig', 'earthquake', 'mudshot', 'gust'], 60, 125],
  ['Steelix','Steel','Ground', 75,85,200,55,65,30, ['metalclaw', 'irontail', 'dig', 'earthquake'], 25, 179],
  ['Snubbull','Fairy',null, 60,80,50,40,40,30, ['dazzlinggleam', 'moonblast', 'tackle', 'quickattack'], 190, 78],
  ['Granbull','Fairy',null, 90,120,50,45,45,45, ['dazzlinggleam', 'moonblast', 'tackle', 'quickattack'], 75, 178],
  ['Qwilfish','Water','Poison', 65,95,85,55,55,85, ['watergun', 'bubble', 'surf', 'hydropump'], 45, 130],
  ['Cizayox','Bug','Steel', 70,130,100,55,80,65, ['stringshot', 'bugbite', 'metalclaw', 'irontail'], 25, 175],
  ['Caratroc','Bug','Rock', 20,10,230,10,230,5, ['stringshot', 'bugbite', 'rockthrow', 'rockslide'], 75, 77],
  ['Scarhino','Bug','Fighting', 80,125,75,40,95,85, ['stringshot', 'bugbite', 'karatechop', 'megapunch'], 45, 175],
  ['Farfuret','Dark','Ice', 55,95,55,35,75,115, ['bite', 'crunch', 'icebeam', 'blizzard'], 60, 132],
  ['Teddiursa','Normal',null, 60,80,50,50,50,40, ['tackle', 'scratch', 'slash', 'quickattack'], 120, 124],
  ['Ursaring','Normal',null, 90,130,75,75,75,55, ['tackle', 'scratch', 'slash', 'quickattack'], 60, 189],
  ['Limagma','Fire',null, 40,40,40,70,40,20, ['ember', 'flamethrower', 'fireblast', 'fieryspin'], 190, 61],
  ['Volcaropod','Fire','Rock', 50,50,120,90,110,30, ['ember', 'flamethrower', 'fireblast', 'fieryspin'], 75, 151],
  ['Cochignon','Ice','Ground', 50,50,40,30,40,50, ['icebeam', 'blizzard', 'powdersnow', 'dig'], 190, 50],
  ['Corayon','Ice','Ground', 100,100,80,60,60,50, ['icebeam', 'blizzard', 'powdersnow', 'dig'], 75, 161],
  ['Corsola','Water','Rock', 55,55,85,65,85,35, ['watergun', 'bubble', 'surf', 'hydropump'], 190, 116],
  ['Rémoraid','Water',null, 35,65,35,65,35,65, ['watergun', 'bubble', 'surf', 'hydropump'], 190, 66],
  ['Octillery','Water',null, 75,105,75,105,75,45, ['watergun', 'bubble', 'surf', 'hydropump'], 45, 184],
  ['Cadoizo','Ice','Flying', 45,55,45,65,45,75, ['icebeam', 'blizzard', 'powdersnow', 'gust'], 45, 126],
  ['Démanta','Water','Flying', 85,40,70,80,140,70, ['watergun', 'bubble', 'surf', 'hydropump'], 25, 168],
  ...
  ['Démolosse','Dark','Fire', 75,90,50,110,80,95, ['bite', 'crunch', 'ember', 'flamethrower'], 45, 195],
  ['Hyporoi','Water','Dragon', 75,95,95,95,95,85, ['watergun', 'bubble', 'surf', 'hydropump'], 45, 207],
  ['Phanpy','Ground',null, 90,60,60,40,40,40, ['dig', 'earthquake', 'mudshot', 'tackle'], 120, 66],
  ['Donphan','Ground',null, 90,120,120,60,60,50, ['dig', 'earthquake', 'mudshot', 'tackle'], 60, 175],
  ['Porygon2','Normal',null, 85,80,90,105,95,60, ['tackle', 'scratch', 'slash', 'quickattack'], 45, 180],
  ['Cerfrousse','Normal','Psychic', 73,95,62,85,65,85, ['tackle', 'scratch', 'slash', 'quickattack'], 45, 163],
  ['Queulorior','Normal',null, 55,20,35,20,45,75, ['tackle', 'scratch', 'slash', 'quickattack'], 45, 61],
  ['Debugant','Fighting',null, 35,35,35,35,35,35, ['karatechop', 'megapunch', 'jumpkick', 'tackle'], 75, 42],
  ['Kapoera','Fighting',null, 50,95,95,35,110,70, ['karatechop', 'megapunch', 'jumpkick', 'tackle'], 45, 159],
  ['Lippouti','Ice','Psychic', 45,30,15,85,65,65, ['icebeam', 'blizzard', 'powdersnow', 'confusion'], 45, 97],
  ['Élekid','Electric',null, 45,63,37,65,55,95, ['thundershock', 'thunderbolt', 'thunder', 'thunderwave'], 45, 106],
  ['Magby','Fire',null, 45,75,37,70,55,83, ['ember', 'flamethrower', 'fireblast', 'fieryspin'], 45, 117],
  ['Écrémeuh','Normal',null, 95,80,105,40,70,100, ['tackle', 'scratch', 'slash', 'quickattack'], 45, 200],
  ['Leuphorie','Normal',null, 255,10,10,75,135,55, ['tackle', 'scratch', 'slash', 'quickattack'], 30, 255],
  ['Raikou','Electric',null, 90,85,75,115,100,115, ['thundershock', 'thunderbolt', 'thunder', 'thunderwave'], 3, 261],
  ['Entei','Fire',null, 115,115,85,90,75,100, ['ember', 'flamethrower', 'fireblast', 'fieryspin'], 3, 261],
  ['Suicune','Water',null, 100,75,115,90,115,85, ['watergun', 'bubble', 'surf', 'hydropump'], 3, 261],
  ['Embrylex','Rock','Ground', 50,64,50,45,50,41, ['rockthrow', 'rockslide', 'stoneedge', 'dig'], 45, 60],
  ['Ymphect','Rock','Ground', 70,84,70,65,70,51, ['rockthrow', 'rockslide', 'stoneedge', 'dig'], 45, 144],
  ['Tyranocif','Rock','Dark', 100,134,110,95,100,61, ['rockthrow', 'rockslide', 'stoneedge', 'bite'], 45, 270],
  ['Lugia','Psychic','Flying', 106,90,130,90,154,110, ['confusion', 'psychic', 'psybeam', 'gust'], 3, 306],
  ['Ho-Oh','Fire','Flying', 106,130,90,110,154,90, ['ember', 'flamethrower', 'fireblast', 'fieryspin'], 3, 306],
  ['Celebi','Psychic','Grass', 100,100,100,100,100,100, ['confusion', 'psychic', 'psybeam', 'vinewhip'], 45, 270],
];
