...
// Fonction pour afficher la légende des couleurs de la carte
function showMapLegend(){
  const legendHTML = `
    <div style="background:var(--light1);padding:16px;border-radius:10px;max-width:300px;">
      <div style="font-size: 15px;font-weight:bold;color:var(--dark1);margin-bottom:12px;">Légende de la carte</div>
      <div style="display:flex;flex-direction:column;gap:8px;">
        <div style="display:flex;align-items:center;gap:10px;">
          <div style="width:20px;height:20px;border-radius:50%;background:#4ade80;border:2px solid var(--dark1);"></div>
          <span style="color:var(--dark1);font-size:13px;">Lieu actuel</span>
        </div>
        <div style="display:flex;align-items:center;gap:10px;">
          <div style="width:20px;height:20px;border-radius:50%;background:#94886B;border:2px solid var(--dark1);"></div>
          <span style="color:var(--dark1);font-size:13px;">Lieu accessible</span>
        </div>
        <div style="display:flex;align-items:center;gap:10px;">
          <div style="width:20px;height:20px;border-radius:50%;background:#524f48;border:2px solid var(--dark1);opacity:0.5;"></div>
          <span style="color:var(--dark1);font-size:13px;">Lieu verrouillé</span>
        </div>
      </div>
    </div>
  `;
  
  // Créer un modal centré
