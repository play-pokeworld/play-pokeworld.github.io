...
function toggleMapHelp(){
 ...
 <div class="map-help-head"> Code couleur de la carte<button class="win-tool-btn"style="background:var(--dark3);color:var(--light2);border:1px solid var(--light1);width:28px;height:28px;font-size: 13px;font-weight:bold;cursor:pointer;"onclick="toggleMapHelp()">✕</button></div>
