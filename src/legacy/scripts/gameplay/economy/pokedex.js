...
function openDexEntry(id){
 ...
 <div class="stat-row"><div class="stat-label">${t('stat_hp')}</div><div class="stat-bar"><div class="stat-fill" data-style="width:${Math.min(100,bhp/2)}%;background:var(--green)"></div></div><div class="stat-val">${bhp}</div></div>
 <div class="stat-row"><div class="stat-label">${t('stat_atk')}</div><div class="stat-bar"><div class="stat-fill" data-style="width:${Math.min(100,batk/2)}%;background:var(--red)"></div></div><div class="stat-val">${batk}</div></div>
 <div class="stat-row"><div class="stat-label">${t('stat_def')}</div><div class="stat-bar"><div class="stat-fill" data-style="width:${Math.min(100,bdef/2)}%;background:var(--blue)"></div></div><div class="stat-val">${bdef}</div></div>
 <div class="stat-row"><div class="stat-label">${t('stat_spe')}</div><div class="stat-bar"><div class="stat-fill" data-style="width:${Math.min(100,bspe/2)}%;background:var(--orange)"></div></div><div class="stat-val">${bspe}</div></div>
 </div>
