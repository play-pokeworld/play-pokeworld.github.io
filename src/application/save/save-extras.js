...
if (typeof useRareCandy !== 'undefined') { if (typeof window !== 'undefined') window.useRareCandy = useRareCandy; if (typeof globalThis !== 'undefined') globalThis.useRareCandy = useRareCandy; }
if (typeof useBoxRareCandy !== 'undefined') { if (typeof window !== 'undefined') window.useBoxRareCandy = useBoxRareCandy; if (typeof globalThis !== 'undefined') globalThis.useBoxRareCandy = useBoxRareCandy; }
if (typeof copyExportText !== 'undefined') { if (typeof window !== 'undefined') window.copyExportText = copyExportText; if (typeof globalThis !== 'undefined') globalThis.copyExportText = copyExportText; }
