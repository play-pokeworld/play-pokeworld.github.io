...
if (typeof travelToRegion !== 'undefined') { if (typeof window !== 'undefined') window.travelToRegion = travelToRegion; if (typeof globalThis !== 'undefined') globalThis.travelToRegion = travelToRegion; }
if (typeof switchMapRegion !== 'undefined') { if (typeof window !== 'undefined') window.switchMapRegion = switchMapRegion; if (typeof globalThis !== 'undefined') globalThis.switchMapRegion = switchMapRegion; }
...
if (typeof PokeActions !== 'undefined' && PokeActions) { try { PokeActions.register('switchMapRegion', switchMapRegion); } catch (_) {} }
