...
export const JOHTO_BADGES = ['falkner','bugsy','whitney','morty','chuck','jasmine','pryce','clair'];
// FIX (2026-08): battle-init.js classifies Johto champions via this list.
if (typeof globalThis !== 'undefined') globalThis.JOHTO_BADGES = JOHTO_BADGES;
if (typeof globalThis !== 'undefined') globalThis.JOHTO_BADGES = JOHTO_BADGES;
...
const EXTRA_LOC_GATES = {
 route12: {quest:27, item:'pokeflute', label:(typeof t==='function'?t('quest_pokeflute'):(typeof t==='function'?t('poke_flute_snorlax'):'Poké Flute / Snorlax'))},
 route16: {quest:27, item:'pokeflute', label:(typeof t==='function'?t('poke_flute_snorlax'):'Poké Flute / Snorlax')},
...
function updateFeatureWindows(){
 ...
 // display:flex on every unlocked feature window, OVERRIDING applyMobileView
 // — a simple tap on the map made the hatchery/training/mine panels pop up
 // "for no reason". Mobile visibility is owned by applyMobileView alone.
 const mobile = typeof document !== 'undefined' && document.body && document.body.classList && document.body.classList.contains('mobile-mode');
 const apply = (win, unlocked) => {
  if(!win) return;
  if(mobile){
   if(!unlocked){ win.style.display = 'none'; win.classList.remove('mobile-visible'); }
   else if(typeof applyMobileView === 'function') applyMobileView();
   return;
  }
  win.style.display = unlocked ? 'flex' : 'none';
 };
 apply(document.getElementById('win-hatchery'), hatcheryUnlocked());
 apply(document.getElementById('win-training'), trainingUnlocked());
 apply(document.getElementById('win-mine'), mineUnlocked());
 apply(document.getElementById('win-base'), secretBaseUnlocked());
}
...
if (typeof nodeDims !== 'undefined') { if (typeof window !== 'undefined') window.nodeDims = nodeDims; if (typeof globalThis !== 'undefined') globalThis.nodeDims = nodeDims; }
if (typeof _regLocs !== 'undefined') { if (typeof window !== 'undefined') window._regLocs = _regLocs; if (typeof globalThis !== 'undefined') globalThis._regLocs = _regLocs; }
if (typeof _startNodes !== 'undefined') { if (typeof window !== 'undefined') window._startNodes = _startNodes; if (typeof globalThis !== 'undefined') globalThis._startNodes = _startNodes; }
if (typeof regionBadgeCount !== 'undefined') { if (typeof window !== 'undefined') window.regionBadgeCount = regionBadgeCount; if (typeof globalThis !== 'undefined') globalThis.regionBadgeCount = regionBadgeCount; }
if (typeof locGateStatus !== 'undefined') { if (typeof window !== 'undefined') window.locGateStatus = locGateStatus; if (typeof globalThis !== 'undefined') globalThis.locGateStatus = locGateStatus; }
if (typeof locGateMessage !== 'undefined') { if (typeof window !== 'undefined') window.locGateMessage = locGateMessage; if (typeof globalThis !== 'undefined') globalThis.locGateMessage = locGateMessage; }
if (typeof zonesUnlockedByClearing !== 'undefined') { if (typeof window !== 'undefined') window.zonesUnlockedByClearing = zonesUnlockedByClearing; if (typeof globalThis !== 'undefined') globalThis.zonesUnlockedByClearing = zonesUnlockedByClearing; }
if (typeof locCleared !== 'undefined') { if (typeof window !== 'undefined') window.locCleared = locCleared; if (typeof globalThis !== 'undefined') globalThis.locCleared = locCleared; }
if (typeof locReachable !== 'undefined') { if (typeof window !== 'undefined') window.locReachable = locReachable; if (typeof globalThis !== 'undefined') globalThis.locReachable = locReachable; }
if (typeof blockingNeighbor !== 'undefined') { if (typeof window !== 'undefined') window.blockingNeighbor = blockingNeighbor; if (typeof globalThis !== 'undefined') globalThis.blockingNeighbor = blockingNeighbor; }
if (typeof recomputeUnlocks !== 'undefined') { if (typeof window !== 'undefined') window.recomputeUnlocks = recomputeUnlocks; if (typeof globalThis !== 'undefined') globalThis.recomputeUnlocks = recomputeUnlocks; }
if (typeof isLocUnlocked !== 'undefined') { if (typeof window !== 'undefined') window.isLocUnlocked = isLocUnlocked; if (typeof globalThis !== 'undefined') globalThis.isLocUnlocked = isLocUnlocked; }
if (typeof hatcheryUnlocked !== 'undefined') { if (typeof window !== 'undefined') window.hatcheryUnlocked = hatcheryUnlocked; if (typeof globalThis !== 'undefined') globalThis.hatcheryUnlocked = hatcheryUnlocked; }
if (typeof trainingUnlocked !== 'undefined') { if (typeof window !== 'undefined') window.trainingUnlocked = trainingUnlocked; if (typeof globalThis !== 'undefined') globalThis.trainingUnlocked = trainingUnlocked; }
if (typeof mineUnlocked !== 'undefined') { if (typeof window !== 'undefined') window.mineUnlocked = mineUnlocked; if (typeof globalThis !== 'undefined') globalThis.mineUnlocked = mineUnlocked; }
if (typeof updateFeatureWindows !== 'undefined') { if (typeof window !== 'undefined') window.updateFeatureWindows = updateFeatureWindows; if (typeof globalThis !== 'undefined') globalThis.updateFeatureWindows = updateFeatureWindows; }
if (typeof mapNodeState !== 'undefined') { if (typeof window !== 'undefined') window.mapNodeState = mapNodeState; if (typeof globalThis !== 'undefined') globalThis.mapNodeState = mapNodeState; }



// --- Exported globals ---
if (typeof canUnlockDirectlyFrom !== 'undefined') { if (typeof window !== 'undefined') window.canUnlockDirectlyFrom = canUnlockDirectlyFrom; if (typeof globalThis !== 'undefined') globalThis.canUnlockDirectlyFrom = canUnlockDirectlyFrom; }
if (typeof hasQuestDone !== 'undefined') { if (typeof window !== 'undefined') window.hasQuestDone = hasQuestDone; if (typeof globalThis !== 'undefined') globalThis.hasQuestDone = hasQuestDone; }
if (typeof hasRequiredItem !== 'undefined') { if (typeof window !== 'undefined') window.hasRequiredItem = hasRequiredItem; if (typeof globalThis !== 'undefined') globalThis.hasRequiredItem = hasRequiredItem; }
if (typeof locBadgeCount !== 'undefined') { if (typeof window !== 'undefined') window.locBadgeCount = locBadgeCount; if (typeof globalThis !== 'undefined') globalThis.locBadgeCount = locBadgeCount; }
if (typeof locGateSatisfied !== 'undefined') { if (typeof window !== 'undefined') window.locGateSatisfied = locGateSatisfied; if (typeof globalThis !== 'undefined') globalThis.locGateSatisfied = locGateSatisfied; }
if (typeof regionOfLoc !== 'undefined') { if (typeof window !== 'undefined') window.regionOfLoc = regionOfLoc; if (typeof globalThis !== 'undefined') globalThis.regionOfLoc = regionOfLoc; }
if (typeof secretBaseUnlocked !== 'undefined') { if (typeof window !== 'undefined') window.secretBaseUnlocked = secretBaseUnlocked; if (typeof globalThis !== 'undefined') globalThis.secretBaseUnlocked = secretBaseUnlocked; }
