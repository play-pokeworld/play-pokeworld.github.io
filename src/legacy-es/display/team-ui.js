  ...
  return `<div class="extracted-template-style-114">
    ...
    ${['preset1', 'preset2', 'preset3'].map((pk, idx) => {
      ...
      return `<div class="extracted-template-style-116">
        <button class="hbtn" data-action="legacy-call" data-call="loadTeamFromPreset" data-call-args="'${pk}'" title="${tr('load_preset_title', {name:G.teamPresets[pk]?.name})}">#${idx + 1} (${count})</button>
