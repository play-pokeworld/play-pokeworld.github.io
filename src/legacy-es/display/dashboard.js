...
function scrollToWin(winId){
 ...
 win.style.boxShadow = '0 0 20px var(--light2)';
...
if (typeof renderDashboardColumns !== 'undefined' && typeof window !== 'undefined') window.renderDashboardColumns = renderDashboardColumns;
if (typeof moveWinToCol !== 'undefined' && typeof window !== 'undefined') window.moveWinToCol = moveWinToCol;
if (typeof moveWinVert !== 'undefined' && typeof window !== 'undefined') window.moveWinVert = moveWinVert;
