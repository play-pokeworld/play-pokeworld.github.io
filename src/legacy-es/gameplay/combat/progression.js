...
function getEvolutionMethodsHtml(id){
 ...
 methods.push(`<div class="extracted-template-style-179">
 ...
 if(methods.length === 0){
 return `<div class="extracted-template-style-180">
 <b>${t("m.progression.4")}</b> ${t("m.progression.3")}
 </div>`;
 }

 return `<div class="extracted-template-style-181">
 <div class="extracted-template-style-182"> ${t("m.progression.2")}</div>
 ${methods.join('')}
 </div>`;
}
