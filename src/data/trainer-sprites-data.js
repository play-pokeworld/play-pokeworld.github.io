...
function trainerProfileImg(profileId, size=72){
 ...
 return `<img class="trainer-sprite-img trainer-profile-img" src="src/assets/images/trainers/profil/${file}" width="${size}" height="${size}" alt="trainer-profile-${safeId}" onerror="this.onerror=null;this.src='src/assets/images/trainers/npcs/Ace%20Trainer%20%28male%29.png';">`;
}
function staffSpriteImg(staffId, size=52){
 const npcFile = STAFF_NPC_SPRITES[staffId];
 if(npcFile){
  const safeFile = String(npcFile).replace(/"/g, '&quot;');
  return `<img class="trainer-sprite-img trainer-staff-img" src="src/assets/images/trainers/npcs/${safeFile}" width="${size}" height="${size}" alt="${staffId}" onerror="this.onerror=null;this.src='src/assets/images/trainers/npcs/Ace%20Trainer%20%28male%29.png';">`;
 }
