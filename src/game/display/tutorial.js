...
function tutorialSteps(){
 return [
  {id:'route1_battles', title:t('tutorial_step_route1_title')||'Premiers combats', desc:t('tutorial_step_route1_desc')||'Gagne 3 combats sauvages sur la Route 1.', how:()=>`${t('tutorial_step_route1_how')} ${tutorialDeviceHint('map')}`, actionLabel:t('tutorial_step_route1_action'), actionCall:'clickLocation', actionArgs:"'route1'", done:()=>((G.wildWinsByLoc||{}).route1||0)>=3, money:300, items:{oran_berry:3}, rewardText:t('tutorial_step_route1_reward')},
