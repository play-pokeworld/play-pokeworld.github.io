...
![Pokémon](https://img.shields.io/badge/pok%C3%A9mon-386-yellow)
![Regions](https://img.shields.io/badge/regions-Kanto%20%7C%20Johto%20%7C%20Hoenn-green)

> **Language note**  
> PokéWorld starts in **English** by default. The game is developed primarily in **French** and fully playable in both languages, but some English text may still be incomplete, awkward, or inconsistent while the game is in development.
...
PokéWorld is a web-based idle game where you explore the regions of **Kanto**, **Johto** and **Hoenn** with your Pokémon team.
...
| Content | Amount |
|---|---|
| Pokémon | **386** (Gens 1–3) + 6 special forms (Castform & Deoxys) |
| Moves | **400** |
| Abilities / talents | **195** |
| Items | **283** |
| Map locations | **175** (48 Kanto · 52 Johto · 75 Hoenn) |
| Main story quests | **177** (60 Kanto · 40 Johto · 77 Hoenn) |
| Side quests | **137** (incl. 28 puzzle quests) |
| Repeatable quests | **23** |
| Puzzle explorations | **30** (riddles, braille, sequences, rituals) |
| Gyms & Leagues | **24 gyms** · 3 regional leagues (15 league trainers) |
| Secret Base rooms | **36 layouts** · **122 decorations** |
...
- Interactive maps for **Kanto**, **Johto** and **Hoenn**.
- Progressive route, town and dungeon unlocking.
- Wild routes with random encounters.
- Towns, gyms and regional leagues.
- Special locations such as Pokémon Tower, Cerulean Cave, Safari Zone, Seafoam Islands, Whirl Islands, Bell Tower, Sky Pillar, Sealed Chamber and more.
- Roaming legendary Pokémon on a shared 12-hour rotation.
- **Mirage Island**, appearing and vanishing on the same 12-hour cycle.
...
- Main story quests for Kanto, Johto and Hoenn.
- Side quests from NPCs.
- Repeatable quests with selectable objectives.
- **Puzzle exploration quests**: riddles, braille tablets, sequences and rituals hidden in dungeons of all three regions — including the full **Regirock / Regice / Registeel** unlock chain (Sealed Chamber → Desert Ruins, Island Cave, Ancient Tomb).
- Quest rewards as one of the main economy sources.
- Regional badge progression.
- Regional completion requirements before accessing the next region.

### 🧬 Collection

- 386 Pokémon currently available (Generations 1–3).
- Pokédex tracking.
- Shiny tracking.
- Talent unlocking.
...
- Special form shops: **Castform** weather forms at the Weather Institute and **Deoxys** forms in Fallarbor.
- Team presets for quick team switching.
...
### 🏝️ Battle Atoll *(endgame)*

- Post-league battle facility inspired by the Battle Frontier.
- Multiple formats — **Tower**, **Factory**, **Arena** and **Dome** — each with its own constraints (rank caps, rental teams, banned items or legendaries).
- Opposing teams, banned Pokémon and the token shop rotate every **12 hours** (shared UTC window with roaming legendaries and Mirage Island).
- Win streaks and **Atoll tokens** to spend in a dedicated shop.

### 🏠 Secret Bases *(Hoenn)*

- Unlocked through the Hoenn story (Route 111 desert quest), with introduction quests to visit and claim your first base.
- **36 canonical room layouts** (caves, trees, shrubs) scattered across 17 Hoenn routes — each route offers its own alcoves.
- **122 collectible decorations** (furniture, mats, posters, dolls) with Emerald-style placement rules.
- Visit empty alcoves before settling, move your base later (with confirmation), and share bases with friends via import / export.
- Place NPC buddies with custom teams and battle them for daily records.
- Established bases grant small comfort bonuses (route loot, money).
...
- 🇫🇷 French — primary development language, fully supported.
